...
/**
 * "Add the landlord app to your home screen."
 *
 ...
 * the landlord dashboard rather than letting the browser nag. Dismissal is
 ...
 * tutorial is not worth the room on a landlord dashboard.
 */
...
const DISMISSED_KEY = 'tms.tenant.install-hint-dismissed';
